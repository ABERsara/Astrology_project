...
const zodiacInfo = {
  Aries: `טלה (21 במרץ – 19 באפריל) <br/> מזל טלה הוא סימן ההתחלות החדשות, מלא באש ותשוקה. ניחנת באומץ ובחיות, עם רצון להוביל ולהנחות. הנחישות שלך מאפשרת לך לפרוץ גבולות וליצור הזדמנויות חדשות.<br/>המלצה: אל תפחד לקחת סיכונים חדשים, והאמן בכוח שלך להגשים חלומות`,
  Taurus: `שור (20 באפריל – 20 במאי)<br/> מזל טלה הוא סימן ההתחלות החדשות, מלא באש ותשוקה. ניחנת באומץ ובחיות, עם רצון להוביל ולהנחות. הנחישות שלך מאפשרת לך לפרוץ גבולות וליצור הזדמנויות חדשות.<br/>המלצה: אל תפחד לקחת סיכונים חדשים, והאמין בכוח שלך להגשים חלומות`,
  Gemini:`טלה (21 במרץ – 19 באפריל) <br/> מזל טלה הוא סימן ההתחלות החדשות, מלא באש ותשוקה. ניחנת באומץ ובחיות, עם רצון להוביל ולהנחות. הנחישות שלך מאפשרת לך לפרוץ גבולות וליצור הזדמנויות חדשות.<br/>המלצה: אל תפחד לקחת סיכונים חדשים, והאמין בכוח שלך להגשים חלומות`,
    ...
    <div className="wheel-container">
      <div className='zodiac-container'>
        ...
        >
          ...
          <h2>{selectedSign}</h2>
          <p dangerouslySetInnerHTML={{ __html: zodiacInfo[selectedSign] }}></p>
        </Modal>
      </div>
